...
Public Class Stock
    Private Const apiUrl As String = "https://api.cottonclassics.com/api/Stock"
    ...
    Private Sub SendQuery_Click(sender As Object, e As EventArgs) Handles SendQuery.Click
        ...
        Try
            ...
            query.Add("Article", ArticleNo.Text)
            ...
            Using httpResponse As HttpWebResponse = webRequest.GetResponse()
                ...
                If httpResponse.ContentType = "application/json" And
                    ...
                    Dim result = JsonConvert.DeserializeObject(responseString, GetType(CC.CustomerAPIData.Stock.StockResponse))
