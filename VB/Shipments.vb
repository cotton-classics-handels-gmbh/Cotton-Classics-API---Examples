...
Public Class Shipments
    Private Const apiUrl As String = "https://api.cottonclassics.com/api/Shipments"
    ...
    Private Sub SendQuery_Click(sender As Object, e As EventArgs) Handles SendQuery.Click
        ...
        Try
            ...
            query.Add("QueryDate", Format(ShipmentDate.Value, "MM-dd-yyyy"))
            ...
            Using httpResponse As HttpWebResponse = webRequest.GetResponse()
                ...
                If httpResponse.ContentType = "application/json" And
                    ...
                    Dim result = JsonConvert.DeserializeObject(responseString, GetType(CC.CustomerAPIData.Shipments.ShipmentResponse))
    ...
    Private Sub Shipments_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        My.Settings.Save()
    End Sub
End Class